...
class Agtresearchagents(models.Model):
    agentid = models.IntegerField(db_column='agentID', primary_key=True)  # Field name made lowercase. The composite primary key (agentID, typeID) found, that is not supported. The first column is selected.
...
class Crpnpccorporationdivisions(models.Model):
    corporationid = models.IntegerField(db_column='corporationID', primary_key=True)  # Field name made lowercase. The composite primary key (corporationID, divisionID) found, that is not supported. The first column is selected.
...
class Crpnpccorporationresearchfields(models.Model):
    skillid = models.IntegerField(db_column='skillID', primary_key=True)  # Field name made lowercase. The composite primary key (skillID, corporationID) found, that is not supported. The first column is selected.
...
class Crpnpccorporationtrades(models.Model):
    corporationid = models.IntegerField(db_column='corporationID', primary_key=True)  # Field name made lowercase. The composite primary key (corporationID, typeID) found, that is not supported. The first column is selected.
    typeid = models.IntegerField(db_column='typeID')  # Field name made lowercase.
...
class Dgmtypeattributes(models.Model):
    typeid = models.IntegerField(db_column='typeID', primary_key=True)  # Field name made lowercase. The composite primary key (typeID, attributeID) found, that is not supported. The first column is selected.
...
class Dgmtypeeffects(models.Model):
    typeid = models.IntegerField(db_column='typeID', primary_key=True)  # Field name made lowercase. The composite primary key (typeID, effectID) found, that is not supported. The first column is selected.
...
class Industryactivity(models.Model):
    typeid = models.IntegerField(db_column='typeID', primary_key=True)  # Field name made lowercase. The composite primary key (typeID, activityID) found, that is not supported. The first column is selected.
...
class Invcontrabandtypes(models.Model):
    factionid = models.IntegerField(db_column='factionID', primary_key=True)  # Field name made lowercase. The composite primary key (factionID, typeID) found, that is not supported. The first column is selected.
    typeid = models.IntegerField(db_column='typeID')  # Field name made lowercase.
...
class Invcontroltowerresources(models.Model):
    controltowertypeid = models.IntegerField(db_column='controlTowerTypeID', primary_key=True)  # Field name made lowercase. The composite primary key (controlTowerTypeID, resourceTypeID) found, that is not supported. The first column is selected.
...
class Invtypematerials(models.Model):
    typeid = models.IntegerField(db_column='typeID', primary_key=True)  # Field name made lowercase. The composite primary key (typeID, materialTypeID) found, that is not supported. The first column is selected.
...
class Invtypereactions(models.Model):
    reactiontypeid = models.IntegerField(db_column='reactionTypeID', primary_key=True)  # Field name made lowercase. The composite primary key (reactionTypeID, input, typeID) found, that is not supported. The first column is selected.
...
class Mapconstellationjumps(models.Model):
    ...
    fromconstellationid = models.IntegerField(db_column='fromConstellationID', primary_key=True)  # Field name made lowercase. The composite primary key (fromConstellationID, toConstellationID) found, that is not supported. The first column is selected.
...
class Mapregionjumps(models.Model):
    fromregionid = models.IntegerField(db_column='fromRegionID', primary_key=True)  # Field name made lowercase. The composite primary key (fromRegionID, toRegionID) found, that is not supported. The first column is selected.
...
class Mapsolarsystemjumps(models.Model):
    ...
    fromsolarsystemid = models.IntegerField(db_column='fromSolarSystemID', primary_key=True)  # Field name made lowercase. The composite primary key (fromSolarSystemID, toSolarSystemID) found, that is not supported. The first column is selected.
...
class Planetschematicspinmap(models.Model):
    schematicid = models.IntegerField(db_column='schematicID', primary_key=True)  # Field name made lowercase. The composite primary key (schematicID, pinTypeID) found, that is not supported. The first column is selected.
...
class Planetschematicstypemap(models.Model):
    schematicid = models.IntegerField(db_column='schematicID', primary_key=True)  # Field name made lowercase. The composite primary key (schematicID, typeID) found, that is not supported. The first column is selected.
    typeid = models.IntegerField(db_column='typeID')  # Field name made lowercase.
    quantity = models.IntegerField(blank=True, null=True)
...
class Ramassemblylinestations(models.Model):
    stationid = models.IntegerField(db_column='stationID', primary_key=True)  # Field name made lowercase. The composite primary key (stationID, assemblyLineTypeID) found, that is not supported. The first column is selected.
...
class Ramassemblylinetypedetailpercategory(models.Model):
    assemblylinetypeid = models.IntegerField(db_column='assemblyLineTypeID', primary_key=True)  # Field name made lowercase. The composite primary key (assemblyLineTypeID, categoryID) found, that is not supported. The first column is selected.
...
class Ramassemblylinetypedetailpergroup(models.Model):
    assemblylinetypeid = models.IntegerField(db_column='assemblyLineTypeID', primary_key=True)  # Field name made lowercase. The composite primary key (assemblyLineTypeID, groupID) found, that is not supported. The first column is selected.
...
class Raminstallationtypecontents(models.Model):
    installationtypeid = models.IntegerField(db_column='installationTypeID', primary_key=True)  # Field name made lowercase. The composite primary key (installationTypeID, assemblyLineTypeID) found, that is not supported. The first column is selected.
    assemblylinetypeid = models.IntegerField(db_column='assemblyLineTypeID')  # Field name made lowercase.
    quantity = models.IntegerField(blank=True, null=True)
...
class Staoperationservices(models.Model):
    operationid = models.IntegerField(db_column='operationID', primary_key=True)  # Field name made lowercase. The composite primary key (operationID, serviceID) found, that is not supported. The first column is selected.
...
class Translationtables(models.Model):
    sourcetable = models.CharField(db_column='sourceTable', primary_key=True, max_length=200)  # Field name made lowercase. The composite primary key (sourceTable, translatedKey) found, that is not supported. The first column is selected.
...
class Trntranslations(models.Model):
    tcid = models.IntegerField(db_column='tcID', primary_key=True)  # Field name made lowercase. The composite primary key (tcID, keyID, languageID) found, that is not supported. The first column is selected.
